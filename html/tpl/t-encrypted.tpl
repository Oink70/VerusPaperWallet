        ...
        <div id="key-bottom">
            <div>
                <i class="font-size-30">
                    <b class="color-red">This is the encrypted private key of your Verus tAddress. Do not share the encrypted private key of your Verus tAddress with anybody!</b><br />
                    It protects the funds stored in that tAddress from unauthorized access. Decrypt before import.
                </i>
                <hr>
            </div>
            ${SVG_KEY}
    ...
    <div id="notes">
        <table>
            ...
            <tr class="row-light">
                ...
                <td colspan="2" id="td-notes" class="font-size-45 font-noto">
                    ${NOTES}
                </td>
            </tr>
        </table>
