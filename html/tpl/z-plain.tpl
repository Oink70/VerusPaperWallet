 ...
 <page size="PWLT-plain" layout="landscape" style="background: url(html/img/noise.png); background-repeat: repeat;">
        ...
        <div id="key-bottom">
            <div>
                <i class="font-size-30">
                    <b class="color-red">This is the plain-text private key of your Verus zAddress. Do not share the plain-text private key of your Verus zAddress with anybody!</b><br />
                    It protects the funds stored in that zAddress from unauthorized access. Cover up whenever possible.
                </i>
                <hr>
            </div>
            ${SVG_KEY}
    ...
    <div id="addr">
        ...
        <div>
            <hr>
            <i class="font-size-30"><b class="color-green">This is your Verus zAddress.<br />Share this with your peers</b> in order to receive zero-knowledge (private) Verus transactions. Import the private key into <b>verus-desktop in native mode</b> in order to check your balance or to access your private funds.</i>
        </div>
    </div>
</page>