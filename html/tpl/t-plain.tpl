 <!--// plain-text tAddress //-->
 <page size="PWLT-plain" layout="landscape" style="background: url(html/img/noise.png); background-repeat: repeat;">
    ...
    <div id="header">
        <svg viewBox="0 0 10313 842" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="1.5">
            ...
            <text x="4719.9" y="660" font-family="Source Sans Pro" font-size="565.193" fill="#fff">
    ...
    <div id="key">
        <div id="key-bottom">
            <div>
                <i class="font-size-30">
                    <b class="color-red">This is the plain-text private key of your Verus tAddress. Do not share the plain-text private key of your Verus tAddress with anybody!</b><br />
                    It protects the funds stored in that tAddress from unauthorized access. Cover up whenever possible.
                </i>
                <hr>
            </div>
            ${SVG_KEY}
    ...
    <div id="notes">
        <table>
            <tr class="">
                <td style="height: 1mm; width: 21%"></td>
                <td style="height: 1mm; width: 79%"></td>
            </tr>
            <tr class="border-bottom">
                <td class="border-right">
                    tAddress&nbsp;<br />
                    <span class="font-size-20">Share with peers&nbsp;</span>
                </td>
                <td class="code">
                    <div class="font-noto font-size-30" style="word-wrap: break-word;">${ADDRESS}</div>
                </td>
            </tr>
            <tr class="row-light border-bottom sticker-height-15">
                <td class="border-right">
                    Private Key&nbsp;<br />
                    <span class="font-size-20">Always keep secret&nbsp;</span>
                </td>
                <td>
                    <div class="font-noto font-size-30" style="word-wrap: break-word; padding: 0.5mm;">${KEY}</div>
                </td>
            </tr>
            <tr class="border-bottom">
                <td class="border-right">
            ...
            <tr class="row-light">
                ...
                <td id="td-notes" class="font-size-45 font-noto">
                    ${NOTES}
                </td>
            </tr>
        </table>
    </div>
    <div id="addr" style="background-color: #fff;">
        ${SVG_ADDRESS}
        <br />
        <div>
            <hr>
            <i class="font-size-30"><b class="color-green">This is your Verus tAddress.<br />Share this with your peers</b> in order to receive transparent (public) Verus transactions. Use a browser to check the balance at <b>explorer.verus.io</b> without importing it into a wallet. Import the private key into <b>verus-desktop</b> in order to access your public funds.</i>
        </div>
    </div>
</page>