...
<page size="PWLT" layout="landscape">
        ...
        <div id="key-bottom">
            <div>
                <i class="font-size-30">
                    <b class="color-red">This is the encrypted private key of your Verus zAddress. Do not share the encrypted private key of your Verus zAddress with anybody!</b><br />
                    It protects the funds stored in that zAddress from unauthorized access. Decrypt before import.
                </i>
                <hr>
            </div>
            ${SVG_KEY}
    ...
    <div id="addr">
        ...
        <div>
            <hr>
            <i class="font-size-30"><b class="color-green">This is your Verus zAddress.<br />Share this with your peers</b> in order to receive zero-knowledge (private) Verus transactions. Decrypt and import the private key into <b>verus-desktop in native mode</b> in order to check your balance or to access your private funds.</i>
        </div>
    </div>
</page>